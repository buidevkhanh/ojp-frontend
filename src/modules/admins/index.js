        ...
        <div class="container-fluid page-body-wrapper">
          ...
          <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
              <li
                class={`nav-item ${
                  screen === AdminScreen.DASHBOARD ? "link-active" : ""
                }`}
              >
                <span
                  class="nav-link"
                  onClick={() => changeScreen(AdminScreen.DASHBOARD)}
                >
              ...
              <li class="nav-item">
                ...
                >
                  ...
                  <span
                    class={`menu-title ${
                      screen === AdminScreen.PROBLEM ? "link-active" : null
                    }`}
                  >
                    Problems
                  </span>
                ...
                <div class="collapse" id="form-elements">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                      <span
                        class="nav-link"
                        onClick={() => changeScreen(AdminScreen.PROBLEM)}
                      >
                        Manage problems
                      </span>
                    </li>
              ...
              <li class="nav-item">
                ...
                >
                  <i class="menu-icon mdi mdi-phone-outline"></i>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                      ...
                      <div>
                        <div class="btn-wrapper">
                          <span class="btn btn-otline-dark align-items-center">
                            <i class="icon-share"></i> Share
                          </span>
                          <span class="btn bt-otline-dark">
